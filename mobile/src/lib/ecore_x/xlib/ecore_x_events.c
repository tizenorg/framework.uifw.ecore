...
_ecore_x_event_handle_button_press(XEvent *xevent)
{
   ...
   INF("ButtonEvent:press time=%u button=%d", (unsigned int)xevent->xbutton.time, xevent->xbutton.button);
...
{
   _ecore_x_last_event_mouse_move = 0;
   INF("ButtonEvent:release time=%u button=%d", (unsigned int)xevent->xbutton.time, xevent->xbutton.button);
